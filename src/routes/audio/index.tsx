...
export default component$(() => {
  ...
  return (
    <main class="mx-auto max-w-lg px-4 py-6">
      <h1 class="mb-6 text-2xl font-bold text-gray-900">Audio Settings</h1>
      ...
      <section class="mb-6 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <label class="flex cursor-pointer flex-col items-center gap-2 rounded-xl border-2 border-dashed border-gray-200 p-6 text-sm text-gray-500 hover:border-indigo-300 hover:text-indigo-600 transition-colors">
              ...
              return (
                <li key={entry.id} class="flex items-center gap-2 py-3">
                  <div class="min-w-0 flex-1">
                    <p class="truncate text-sm font-medium text-gray-800">{entry.name}</p>
                    <p class="text-xs text-gray-400">{formatSize(entry.size)}</p>
                  </div>
                  <button
                    class="rounded-lg bg-gray-100 px-2.5 py-1 text-xs font-medium text-gray-600 hover:bg-gray-200 disabled:opacity-50 transition-colors"
                  ...
                  <button
                    class="rounded-lg px-2 py-1 text-xs text-gray-400 hover:bg-red-50 hover:text-red-500 transition-colors"
